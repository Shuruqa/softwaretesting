...
public void test() throws Exception {
    ...
    driver.findElementByXPath("/hierarchy/android.widget."
    ...
    touchAction.longPress(LongPressOptions.longPressOptions().withElement(ElementOption.element(driver.findElement(from)))).moveTo(PointOption.point(pressX, topY)).release().perform();
    Thread.sleep(4000);
